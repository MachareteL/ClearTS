...
import logo from "../../public/empregados.png";
...
export default function NavBar() {
  ...
  const navigation = [
    {
      name: "HomePage",
      href: "/",
      current: route.pathname == "/" ? true : false,
    },
    {
      name: "Produtos",
      href: "/products/all",
  ...
  return (
    <Disclosure
      as="nav"
      className={classNames("bg-[#fff] border-b border-[#e3e9ed] shadow-sm")}
    >
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-start ml-10 md:items-stretch md:justify-between">
                ...
                >
                  ...
                  />
                  <span
                    className={`${pacifico.className} text-5xl text-[#0f73ee] logo`}
                  >
                    Clear
                  </span>
                </div>
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current
                            ? "text-indigo-700 relative after:absolute after:w-full after:h-[3px] after:left-0 after:bottom-0 after:origin-left after:transition ease-in-out after:duration-300 after:bg-indigo-700"
                            : "text-indigo-700 relative after:absolute after:w-full after:h-[3px] after:left-0 after:bottom-0 after:origin-left after:scale-0 after:transition ease-in-out after:duration-300 hover:after:scale-100 after:bg-indigo-700",
              ...
              <div className="absolute justify-evenly w-fit md:w-28 inset-y-0 right-0 flex items-center pr-2 md:static md:inset-auto md:ml-6 md:pr-0">
                ...
                <Cart
                  cartState={aberto}
                  setCartStateFalse={() => setOpen(false)}
                />
              ...
              <div className="space-y-1 px-2 pt-2 pb-3">
                {navigation.map((item) => (
                  <Disclosure.Button
                    ...
                    className={classNames(
                      item.current
                        ? "text-[#96116b] underline underline-offset-1"
